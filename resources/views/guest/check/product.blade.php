...
<div class="col-12 col-md-8 productContent">
  <div class="row">
    ...
    {{-- LEGALITY IMG --}}
    <div class="col-12 col-sm-8 offset-sm-2  col-lg-6 mt-lg-1 @if($legality !== 'illegal') col-lg-6 offset-lg-1 @else col-lg-8 offset-lg-2  @endif  d-flex justify-content-center mb-2 mb-md-3 mb-lg-1">
    ...
    {{-- //LEGALITY IMG --}}
      ...
      {{-- DA LI JE OK ZA VEGANE I VEGETARIJANCE --}}
        @if(count($okFor))
      <div class="rounded  okFor col-8 offset-2 px-2 py-0 col-lg-3  offset-lg-0 mb-3 mb-md-2  d-flex justify-content-center align-items-center flex-column">
          ...
          <br><p class="c1" data-toggle="tooltip" data-placement="top"
           ...
           @else title="{{$legality == "vegetarian"? "Proizvod sadrži sastojke životinjskog porekla. Molimo proverite dodatne informacije ili deklaraciju proizvoda." : "Proizvod ne sadrži sastojke životinjskog porekla"}}" @endif>Sta ovo znači <i class="c1 far fa-question-circle"></i></p>
        </p>
      ...
      {{-- SLIKE --}}
      <div class="col-12 mb-4 mb-lg-3 pl-md-5 mt-lg-3 productImgs">
     ...
     <div class="col-10 offset-1 col-lg-10 offset-lg-1 mb-1 mb-md-2 mt-lg-2 productDescr pt-lg-4 pb-lg-1 mb-lg-5">
...
{{-- TAGOVI --}}
<div class="col-12 col-md-4 productTags mb-2 mb-md-4 pr-lg-5">
...
<div class="col-12 col-md-8 mt-1 mb-3">
...
<div class="col-12 col-md-8 mt-1 mb-3 mb-lg-5">
@include('guest.check.recommendedProducts')
</div>
@endif

@if($similarProducts->count())
<div class="col-12 col-md-8 mt-2 mt-lg-3 mb-4 mb-lg-4">
