  ...
  <div class="isVegan my-4">
    <h4><strong>Da li je proizvod veganski/vegeterijanski?</strong></h4>
     <div class="form-check">
       ...
       @errors @if(old('legality')==1) checked @endif @else @if($suggestion->legality == 1) checked @endif  @enderrors
         >
     ...
     <div class="form-check">
       ...
       @errors @if(old('legality')==2) checked @endif @else @if($suggestion->legality == 2) checked @endif  @enderrors
        >
       <label class="form-check-label">
         Vegeterijanski
       </label>
     ...
     <div class="form-check">
       ...
       @errors @if(old('legality')==3) checked @endif @else @if($suggestion->legality == 3) checked @endif  @enderrors
         >
       <label class="form-check-label">
